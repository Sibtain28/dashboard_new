 ...
 * "Molten Grid" refined: same control-room language — blueprint grid,
 * furnace-glow skyline, ember particles — now with layered glass,
 * a scanning blueprint sweep, live status telemetry, and validation
 * states, so the page reads as a shipped Fortune 500 product rather
 * than a concept mockup. The orange ember stays the single accent
 * color; blue carries authority; green is reserved for system status.
 */
...
function Skyline() {
  return (
    ...
    >
      ...
      {/* pipeline outlines running along the base */}
      <g fill="none" stroke="#1C3453" strokeWidth="3">
        <path d="M0 288 H1600" />
        <path d="M0 294 H1600" strokeDasharray="2 10" opacity="0.6" />
      </g>
      {/* signature red/white banded chimney stacks, echoing the real plant silhouette */}
      <g opacity="0.9">
...
/* CAD-style dimension annotations, kept faint and decorative */
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-[#081A2F] font-sans">
      ...
      >
        ...
        {/* focus vignette centered behind the card */}
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-5 py-28">
        ...
        >
          <div className="group relative">
            ...
            {/* outer layer: soft elevation + hover glow border */}
            <div
            ...
            >
              {/* inner glass layer */}
              <div
                className="relative rounded-[29px] p-8 md:p-10 overflow-hidden"
                style={{
                  background:
              ...
              >
                ...
                <div className="relative">
                  <div
                    ...
                    style={{ animation: "rise-in 0.6s ease-out 0.5s forwards" }}
                  >
                  ...
                  <h1
                    className="font-display text-[34px] md:text-[38px] font-bold text-white tracking-[-0.02em] leading-[1.05] opacity-0"
                    style={{ animation: "rise-in 0.6s ease-out 0.55s forwards" }}
                  >
                    Welcome Back
                  </h1>
                  <p
                    className="mt-2.5 text-gray-400 text-[13.5px] mb-8 opacity-0"
                    style={{ animation: "rise-in 0.6s ease-out 0.62s forwards" }}
                  >
                    Access your Jindal Steel Power Plant Dashboard
                  </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                    ...
                    <div
                      ...
                      style={{ animation: "rise-in 0.6s ease-out 0.84s forwards" }}
                    >
                    ...
                    <button
                      ...
                      className="relative w-full rounded-full py-4.5 font-semibold text-white overflow-hidden transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.02] active:scale-[0.97] disabled:opacity-90 opacity-0"
                      style={{
                    ...
                    <div
                      className="flex items-center gap-3 pt-1 opacity-0"
                      style={{ animation: "rise-in 0.6s ease-out 1s forwards" }}
                    >
                    ...
                    <button
                      ...
                      style={{ animation: "rise-in 0.6s ease-out 1.06s forwards" }}
                    >
                  ...
                  <p
                    className="mt-7 text-center text-sm text-slate-400 opacity-0"
                    style={{ animation: "rise-in 0.6s ease-out 1.12s forwards" }}
                  >
                    New to the platform?{" "}
          ...
          {/* footer */}
          <div
            className="mt-7 flex flex-col items-center gap-2.5 opacity-0"
            style={{ animation: "rise-in 0.6s ease-out 1.2s forwards" }}
          >
